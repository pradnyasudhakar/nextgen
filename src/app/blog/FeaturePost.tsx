          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-md overflow-hidden border border-[#9C9C9C]  hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="bg-[#FBFBFB] p-8 border-b-4  border-b-primary lg:p-10 flex flex-col justify-center">
              ...
              {featuredPost.excerpt && (
                <P className="text-[#555555] text-[1rem] font-[500] leading-relaxed mb-6">
                  {featuredPost.excerpt}
                </P>
              )}
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <P className="text-[1rem]  text-[#555555] mb-2 leading-none">
                      By{" "}
                    ...
                    <P className="text-[0.72rem] text-[#9C9C9C] mt-1 leading-none">
